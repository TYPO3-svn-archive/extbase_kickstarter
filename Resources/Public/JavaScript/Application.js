 ...
 * @singleton
 */
Tx.ExtbaseKickstarter.Application = Ext.apply(new Ext.util.Observable, {
	...
	bootstrap: function() {
		...
		this.fireEvent('Tx.ExtbaseKickstarter.Application.afterBootstrap');
	},
...
Ext.onReady(Tx.ExtbaseKickstarter.Application.bootstrap, Tx.ExtbaseKickstarter.Application);